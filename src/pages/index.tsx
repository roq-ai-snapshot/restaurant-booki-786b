  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Experience seamless dining with Restaurant Booking Engine - Simplifying reservations, enhancing customer experiences, and empowering restaurant staff to manage tables and menus efficiently."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience seamless dining with Restaurant Booking Engine - Simplifying reservations, enhancing customer experiences, and empowering restaurant staff to manage tables and menus efficiently.`}
            </Text>
            <Box
